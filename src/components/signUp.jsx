...
//             <div className="person-icon  mb-2 fs-1 text-secondary" >           <i className="bi bi-person-circle"></i>
// </div>
        ...
        <Col md={6} className="left-section">
          <div className="form-container">
            <div className="person-icon mb-2 fs-1 text-secondary">
              <i className="bi bi-person-circle"></i> {/* ✅ Corrected */}
            </div>
            <h1 className="text-center fs-3">Create Account</h1>

            <Formik
              initialValues={{ name: "", email: "", password: "" }}
              validationSchema={validationSchema}  // ✅ Correct prop
              onSubmit={handleSubmit}
              validateOnChange={true}  // ✅ Optional but ensures validation works immediately
